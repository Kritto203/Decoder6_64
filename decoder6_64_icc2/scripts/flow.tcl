...
if {![file exists "decoder6_64/"]} {
	create_lib  decoder6_64 -technology ../ref/tech/NDM/saed14rvt_1p9m.tf -ref_libs ../ref/lib/NDM/saed14rvt_frame_only.ndm/
}
read_verilog ../source/decoder6_64_compiled.v
...
check_lvs -nets [get_nets] -checks {short open} -check_child_cells true -report_floating_pins true -open_reporting detailed > decoder6_64.err

write_parasitics -output ../results/decoder6_64.spef -no_name_mapping -compress -hierarchical -rde_corr -format spef

write_verilog ../results/decoder6_64_compiled.v -include all

set design decoder6_64
set gdsout_map ../ref/tech/saed14nm_1p9m_gdsout_mw_icc2.map
set gds_files ../ref/tech/saed14_rvt.gds


write_gds	-design $design 		-layer_map $gdsout_map 		-output_pin all 		-hierarchy all		-keep_data_type 		-merge_files $gds_files		-merge_gds_top_cell $design		-units 2000		-lib_cell_view frame	-allow_design_mismatch	decoder6_64_compiled.gds
