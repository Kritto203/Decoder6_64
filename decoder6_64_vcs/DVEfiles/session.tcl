...
# DVE full session
# Saved on Fri Aug 16 16:49:37 2024
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{10 35} {1188 730}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 165} {height 421} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 165} {height 421} {dock_state left} {dock_on_new_line true} {child_data_colvariable 103} {child_data_colvalue 25} {child_data_coltype 37} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1178} {height 175} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 148} {child_wave_right 693} {child_wave_colname 114} {child_wave_colvalue 30} {child_wave_col1 0} {child_wave_col2 1}}
...
set _session_group_2 tb_decoder6_64
gui_sg_create "$_session_group_2"
set tb_decoder6_64 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { tb_decoder6_64.CLK_HALF_PERIOD tb_decoder6_64.CLK_PERIOD tb_decoder6_64.A tb_decoder6_64.Y tb_decoder6_64.en tb_decoder6_64.clk }
...
gui_wv_zoom_timerange -id ${Wave.1} 0 32
...
gui_marker_move -id ${Wave.1} {C1} 32
